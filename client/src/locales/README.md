# Nashm Localization Guide

This guide explains how to add new languages to Nashm's localization system.

## Adding a New Language

To add a new language to Nashm, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [Nashm locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through Nashm's automated translation platform

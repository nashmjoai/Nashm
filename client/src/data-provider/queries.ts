...
/**
 * Hook for getting available Nashm tools (excludes MCP tools)
...
export const useGetAdminConsoleOverviewQuery = (
  config?: UseQueryOptions<any>,
): QueryObserverResult<any> => {
  return useQuery<any>(['adminConsoleOverview'], () => dataService.getAdminConsoleOverview(), {
    refetchOnWindowFocus: false,
    ...config,
  });
};

export const useGetAdminConsoleUsersQuery = (
...
export const useGetAdminConsoleModelsQuery = (
  ...
  return useQuery<any>(['adminConsoleModels'], () => dataService.getAdminConsoleModels(), {
    refetchOnWindowFocus: false,
    ...config,
  });
};

...
import { Permissions, SystemRoles } from 'nashm-data-provider';
import {
  OGDialog,
  OGDialogTitle,
  OGDialogContent,
...
import type { PermissionTypes } from 'nashm-data-provider';
                    ...
                    {showAdminWarning &&
                      ...
                      permission === Permissions.USE && (
                        <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                          ...
                          {'\n'}
                          <a
                            href="https://www.Nashm.ai/docs/configuration/Nashm_yaml/object_structure/interface"
                            target="_blank"
                            rel="noreferrer"

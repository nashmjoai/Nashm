...
const AdminDashboardButton = memo(function AdminDashboardButton() {
  const localize = useLocalize();
  ...
  const isActive = location.pathname.startsWith('/admin-console');
    ...
    <TooltipAnchor
      ...
      render={
        <Button
          ...
          className={cn(
            'h-9 w-9 rounded-lg text-text-secondary hover:bg-surface-hover',
            isActive ? 'bg-surface-active-alt text-text-primary' : 'text-text-secondary',
          )}
      ...
      <TooltipAnchor
        ...
        render={
          <Button
            ...
            className="group h-9 w-9 rounded-lg relative overflow-hidden flex items-center justify-center transition-all duration-300 hover:bg-red-55 dark:hover:bg-red-950/20"
            onClick={toggleClick}
          >
            <div className="relative h-7 w-7 flex items-center justify-center">
              ...
              <Sidebar
                aria-hidden="true"
                className="absolute h-5 w-5 text-[#C41E3A] transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100"
              />
            </div>
          </Button>
        }

  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-white dark:bg-gray-900 nashm-auth-bg">
      ...
      <BlinkAnimation active={isFetching}>
        <div className="mt-24 mb-6 flex flex-col items-center justify-center w-full">
          <div className="relative group">
            ...
            <img
              src="/assets/logo.png"
              className="relative h-56 w-56 object-contain nashm-logo-glow transition-transform duration-500 hover:scale-105"

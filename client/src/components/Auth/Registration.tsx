...
import { ThemeContext, SecretInput, Spinner, Button, isDark } from '@nashm/client';
import { useNavigate, useOutletContext, useLocation } from 'react-router-dom';
import { useRegisterUserMutation } from 'nashm-data-provider/react-query';
import { loginPage } from 'nashm-data-provider';
import type { TRegisterUser, TError } from 'nashm-data-provider';

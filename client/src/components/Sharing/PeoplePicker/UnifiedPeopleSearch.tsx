...
import type { TPrincipal, PrincipalType, PrincipalSearchParams } from 'nashm-data-provider';
import { useSearchPrincipalsQuery } from 'nashm-data-provider/react-query';

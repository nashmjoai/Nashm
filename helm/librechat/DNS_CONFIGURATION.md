# DNS Configuration for Nashm Helm Chart

This feature allows you to configure custom DNS settings for Nashm pods, enabling traffic redirection to proxy servers or custom endpoints.
...
Deploy:
```bash
helm upgrade --install Nashm ./helm/Nashm -f values.yaml
```
...
✅ **Integration Test**
- Works with existing Nashm configuration
...
- Kubernetes 1.19+
- Compatible with all Nashm deployment modes

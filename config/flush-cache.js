...
/**
 * Nashm Cache Flush Utility
 *
 * This script flushes the cache store used by Nashm, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Nashm. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Nashm backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Nashm Cache Flush Utility');
  console.log('================================');

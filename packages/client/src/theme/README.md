# Dynamic Theme System for @nashm/client
...
```bash
npm install @nashm/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@nashm/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@nashm/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@nashm/client';
...
```tsx
import { useTheme } from '@nashm/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@nashm/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@nashm/client';
...
This theme system is part of the @nashm/client package. 
 ...
 *
 * Exercises the FULL Nashm -> agents pipeline:
 *   Nashm's createRun (@nashm/api)
...
(hasAnthropic ? describe : describe.skip)('Anthropic Summarization E2E (Nashm)', () => {
...
(hasOpenAI ? describe : describe.skip)('OpenAI Summarization E2E (Nashm)', () => {
  jest.setTimeout(180_000);
...
(hasBothProviders ? describe : describe.skip)(
  'Cross-provider Summarization E2E (Nashm)',
  () => {
    jest.setTimeout(180_000);

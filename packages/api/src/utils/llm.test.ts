import { extractNashmParams } from './llm';

describe('extractNashmParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractNashmParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractNashmParams();
  ...
  it('should extract all Nashm params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractNashmParams(options);
  ...
  it('should handle null values for Nashm params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Nashm params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractNashmParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Nashm params', () => {
    const options = {
      resendFiles: false,

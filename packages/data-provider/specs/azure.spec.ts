...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'Nashm-westus'
    expect(groupMap).toHaveProperty('Nashm-westus');
    expect(groupMap['Nashm-westus']).toEqual(
    ...
    // Check groupMap for 'Nashm-eastus'
    expect(groupMap).toHaveProperty('Nashm-eastus');
    expect(groupMap['Nashm-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'Nashm-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'Nashm-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'Nashm-eastus',

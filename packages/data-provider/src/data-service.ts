...
export function getAdminConsoleOverview(): Promise<any> {
  return request.get(endpoints.adminConsoleOverview());
}

export function getAdminConsoleUsers(params?: Record<string, unknown>): Promise<any> {
  return request.get(endpoints.adminConsoleUsers(params));
}

export function upsertAdminSubscription(payload: any): Promise<any> {
  return request.post(endpoints.adminConsoleSubscription(), payload);
}

export function getAdminConsoleModels(): Promise<any> {
  return request.get(endpoints.adminConsoleModels());
}

export function updateAdminConsoleModel(payload: any): Promise<any> {
...
export function updateAdminConsoleTicket(id: string, status: string): Promise<any> {
...
// Family Plan Requests
export function getFamilyPlan(): Promise<any> {
  return request.get(endpoints.familyPlan());
}

export function addFamilyMember(email: string): Promise<any> {
  return request.post(endpoints.familyPlanMembers(), { email });
}

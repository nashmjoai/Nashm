...
export const adminConsoleOverview = () => `${BASE_URL}/api/admin/console/overview`;
export const adminConsoleUsers = (params?: Record<string, unknown>) =>
  `${BASE_URL}/api/admin/console/users${params ? buildQuery(params) : ''}`;
...
export const familyPlan = () => `${BASE_URL}/api/family`;

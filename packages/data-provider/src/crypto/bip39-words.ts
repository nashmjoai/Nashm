 ...
 * 12 words from 2048 words = 2^132 entropy (~132-bit security against offline brute-force)
 */
export const BIP39_ENGLISH_WORDLIST: string[] = [
  ...
  'base', 'basic', 'basket', 'battle', 'beach', 'beacon', 'beam', 'bean', 'beauty', 'because',
  ...
  'close', 'cloth', 'cloud', 'clown', 'club', 'clump', 'cluster', 'clutch', 'coach', 'coal',
  ...
  'day', 'deal', 'debate', 'debris', 'decade', 'december', 'decide', 'decline', 'decor', 'decrease',
  ...
  'market', 'marry', 'mask', 'mass', 'master', 'match', 'material', 'math', 'matrix', 'matter',
  ...
  'certain', 'service', 'session', 'settle', 'setup', 'seven', 'shadow', 'shaft', 'shallow', 'share',
  ...
  'simple', 'since', 'sing', 'siren', 'sister', 'sitate', 'six', 'size', 'skate', 'sketch',
  'ski', 'skill', 'skin', 'skirt', 'skull', 'slap', 'slate', 'slept', 'slide', 'slight',
  'slim', 'slogan', 'slot', 'slow', 'sludge', 'small', 'smart', 'smile', 'smoke', 'smooth',
  ...
  'useless', 'usual', 'utility', 'vacant', 'vacuum', 'vague', 'valuable', 'value', 'valve', 'van',
  'vanish', 'vapor', 'various', 'vast', 'vault', 'vehicle', 'velvet', 'vendor', 'venture', 'venue',
  'verb', 'verify', 'version', 'very', 'vessel', 'veteran', 'vial', 'vibrant', 'vicious', 'victory',
  'video', 'view', 'village', 'vintage', 'violin', 'virtual', 'virtue', 'virus', 'visa', 'visit',

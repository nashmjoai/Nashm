/**
 * Inlined utility functions previously imported from @nashm/api.
 ...
 *
 * Inlined from @nashm/api findMatchingPattern
 */
 ...
 *
 * Inlined from @nashm/api matchModelName (simplified for test use)
 */

import { EModelEndpoint, agentsEndpointSchema } from 'nashm-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'nashm-data-provider';

/**
 * Sets up the Agents configuration from the config (`Nashm.yaml`) file.

...
/**
 * Sets up Model Specs from the config (`Nashm.yaml`) file.
...
For more information, see the documentation at https://www.Nashm.ai/docs/configuration/Nashm_yaml/object_structure/model_specs#endpoint`);
      continue;
    }

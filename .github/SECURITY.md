...
We are committed to maintaining the security of our open-source project, Nashm, and promptly addressing any identified vulnerabilities. To ensure the security of our project, we adhere to the following practices:
...
- Repository: [Nashm](https://github.com/aabuzaid1/Nashm.git)

## Contact

If you have any questions or concerns regarding the security of our project, please report them by [opening an issue](https://github.com/aabuzaid1/Nashm/issues/new) on GitHub. Please note that the response time may vary depending on the nature and severity of the inquiry.
